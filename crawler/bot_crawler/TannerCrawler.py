...
class TannerCrawler(st.Site):
    ...
    def get_cats(self):
        if(self.url == "https://www.tannerbolt.com/?page=customer&file=customer/tabonu/b2bse/includes/shop.aspx"):
            return self.browser.find_elements_by_css_selector("div.HomeCat")
        else:
            return self.browser.find_elements_by_css_selector("div.CategoryWrapper") 

    # param browser object of a category tag
    # return the name of the category as a string
    def get_cat_name(self, cat):
    	return cat.find_element_by_css_selector("div.catname > p").text
